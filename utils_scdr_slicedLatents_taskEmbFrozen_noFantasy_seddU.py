...
## sampling function
def get_sample(net, seq_len, vocab_size, num_sampling_steps, sample_batch_size, sample_condition, cfg_scale, sampling_eps, device, eps=1e-5):
    # x_T
    ...
    for i in range(num_sampling_steps):
        ...
        # x_(t-1)
        x_t_minus1, sampling_eps =  sample_categorical(probs, sampling_eps)
    ...
    flip_counts = (flip_counts - 1).float().mean().item()
